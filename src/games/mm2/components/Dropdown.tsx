  ...
  return (
    <div ref={ref} className={`relative ${fullWidth ? "w-full" : ""}`}>
      <button
        ...
        className={
          fullWidth
            ? "flex w-full items-center justify-between gap-1.5 rounded-lg border border-zinc-200 bg-white p-2 text-left text-sm text-zinc-900 outline-none focus:border-red-400 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      ...
      {open && (
        <div
          className={`absolute top-full z-20 mt-1 max-h-64 min-w-full overflow-y-auto rounded-lg border border-zinc-200 bg-white py-1 shadow-lg dark:border-red-500/15 dark:bg-[#171114] ${
